...
public class StartToBoilerPegToBoilerMode extends AutoModeBase 
{
    ...
    public StartToBoilerPegToBoilerMode(boolean _isBlue, FieldDimensions _fieldDimensions) 
    {
    	isBlue = _isBlue;
    ...
    private void init()
    {
		...
		Pose pegPose = fieldDimensions.getBoilerPegBasePose();
    ...
    {
    	System.out.println("Starting StartToBoilerPegToBoilerMode");
